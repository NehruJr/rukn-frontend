export const LEAD_STATUSES = [
  ...
  { value: 'viewing_scheduled', label: 'Viewing Scheduled', color: '#F59E0B' },
  { value: 'negotiating', label: 'Negotiating', color: '#EF4444' },
  { value: 'converted', label: 'Converted', color: '#059669' },
  { value: 'lost', label: 'Lost', color: '#6B7280' },
  { value: 'unqualified', label: 'Unqualified', color: '#9CA3AF' }
];
